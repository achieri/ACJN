...
jQuery(function() {
    ...
    if (!($.browser.msie && $.browser.version < 7)){
        $('ul ul a', '#menu').css({background: 'none'}).hover(
            function(){ $(this).css({backgroundColor: 'rgb(43,46,50)'}).animate({backgroundColor: 'rgb(127,90,43)'}, 300); },
            function(){ $(this).animate({backgroundColor: 'rgb(43,46,50)'}, {duration : 100, complete : function(){
